...
UPDATE works SET
  ...
  meta_description    = 'Graphxify redesigned the FlyUp Line travel platform to simplify booking, build traveller trust, and drive conversion. See the design approach.',
