...
create table if not exists public.profiles (
  ...
  role_id smallint not null default 2 references public.app_roles(id) on update cascade on delete restrict,
...
create table if not exists public.posts (
  ...
  related_service text check (related_service in ('brand-systems', 'web-design', 'web-development', 'cms-architecture')),
