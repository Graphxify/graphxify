    ...
    <section className={cn("relative", className)}>
      ...
      <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr] lg:gap-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-border/20 bg-card/78 p-2.5">
          <div className="relative h-[22rem] overflow-hidden rounded-[1.65rem] md:h-[32rem]">
          ...
          <div className="absolute bottom-5 left-5 z-10 flex items-center gap-2">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-border/28 bg-bg/58 text-fg/74 backdrop-blur">
        ...
        <div className="section-shell border-border/20 bg-card/72 p-6 md:p-8 lg:p-10">
          ...
          <div className="mt-8 border-t border-border/16 pt-7">
            <div className="space-y-3">
              {founderRoles.map((role, index) => (
                <div key={role.title} className="grid grid-cols-[1fr_auto] items-center gap-6 border-b border-border/10 pb-3 text-[0.98rem] text-fg/78 md:text-[1.1rem]">
                  <p>{role.title}</p>
                  <p className="text-fg/56">
