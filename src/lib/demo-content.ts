...
export const demoPosts = [
  {
    id: "p1",
    title: "Enterprise Website Governance in 2026",
    slug: "enterprise-website-governance-2026",
    excerpt: "A practical model for balancing delivery speed with content quality at scale.",
    content: "In this guide, we break down governance foundations for enterprise content pipelines.",
    cover_image_url: "/assets/post-1.svg",
    created_at: "2026-02-10"
  },
  {
    id: "p2",
    title: "How to Design an Audit-Ready CMS",
    slug: "how-to-design-an-audit-ready-cms",
    excerpt: "Auditability is a product feature. Here is how to implement it cleanly.",
    content: "From role boundaries to event metadata, this article covers implementation details.",
    cover_image_url: "/assets/post-2.svg",
    created_at: "2026-01-29"
  },
  {
    id: "p3",
    title: "Performance Patterns for Premium Agency Sites",
    slug: "performance-patterns-premium-agency-sites",
    excerpt: "A concise set of patterns that push Lighthouse scores into production-safe territory.",
    content: "Server components, selective hydration, and query discipline.",
